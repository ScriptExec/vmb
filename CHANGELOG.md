# Version 0.4.0
This release introduces a new `mod` subcommand with features to list and toggle installed mods, allowing users to manage their mods more easily without opening the game.
